<if cond="!isset({pg->get})"><p class="error">Ce membre n'existe pas</p></if>
<else>
...
<div class="menu_module">
	<a href="admin-histo.html?mid={mid}&amp;module=war&amp;sub=atq" title="Attaques de vos légions sur les autres joueurs">Attaque</a>
	<a href="admin-histo.html?mid={mid}&amp;module=war&amp;sub=def" title="Attaques des autres joueurs sur vos légions">Défense</a>
</div>
...
function CopyJournalToBBCode(aid) {
	...
	var url = "{cfg_url}ajax--admin-histo.html?mid={mid}&module=war&aid="+aid;
	var method = "GET";
	var data = 'null';
...
<dl>
	...
	<if cond="{value[atq_mid1]} == {_user[mid]}">
		Vous attaquez <a href="member-<math oper="Template::str2url({value[mbr_pseudo2]})"/>.html?mid={value[atq_mid2]}">{value[mbr_pseudo2]}</a>
	</if>
